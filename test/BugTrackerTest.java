...
public class BugTrackerTest {
    ...
    public void addComment(){
        ...
        assertEquals(employee.addCommentForBug(3,"bug in progress"),true);
    }

    @Test
    public void addBug(){
        Employee employee = new Employee(12,"Carmen","carmen@yahoo.com");
        assertEquals(employee.addBug(9,3,"app blocks","bug open","2","web","ss.jpg","can't open",12),true);
    }
    ...
    public void updateProduct(){
        ...
        assertEquals(product.getDescriere(),"mobile");
